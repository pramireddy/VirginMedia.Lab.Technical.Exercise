...
namespace Lab.Technical.Exercise.WebApp
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IScenarioRepository, ScernarioRepository>();
            services.AddScoped<IScenarioService, ScenarioService>();
            services.Configure<DataSettings>(Configuration.GetSection("DataFile"));
